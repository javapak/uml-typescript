/**
 * Implementation class for ReadStructuralFeatureAction
 * 
 * @since UML 2.5
 * @package uml
...
export class ReadStructuralFeatureAction extends StructuralFeatureAction implements IReadStructuralFeatureAction {
  /**
   * result
   * 
   * @type OutputPin
  ...
  constructor(init?: Partial<IReadStructuralFeatureAction>) {
    super(init);
   ...
   */
  toJSON(): IReadStructuralFeatureAction {
   ...
   */
  clone(): ReadStructuralFeatureAction {
    return new ReadStructuralFeatureAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IReadStructuralFeatureAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof ReadStructuralFeatureAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `ReadStructuralFeatureAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): ReadStructuralFeatureAction {
    const instance = new ReadStructuralFeatureAction();
  ...
  static validate(instance: IReadStructuralFeatureAction): ValidationResult {
    if (instance instanceof ReadStructuralFeatureAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new ReadStructuralFeatureAction(instance);
