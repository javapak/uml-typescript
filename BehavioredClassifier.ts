...
export class BehavioredClassifier extends Classifier implements IBehavioredClassifier {
  ...
  constructor(init?: Partial<IBehavioredClassifier>) {
    ...
    this.classifierBehavior = init?.classifierBehavior;
    this.interfaceRealization = init?.interfaceRealization ? new Set(init.interfaceRealization) : new Set();
    this.ownedBehavior = init?.ownedBehavior ? new Set(init.ownedBehavior) : new Set();
  }
  getClassifierBehavior(): string | undefined {
    return this.classifierBehavior;
  }

  setClassifierBehavior(value: string | undefined): void {
