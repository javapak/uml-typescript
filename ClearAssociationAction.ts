/**
 * Implementation class for ClearAssociationAction
 * 
 * @since UML 2.5
 * @package uml
 * @extends Action
...
export class ClearAssociationAction extends Action implements IClearAssociationAction {
  /**
   * association
   * 
   * @type Association
   ...
   */
  public association!: IAssociation | string;
  ...
  constructor(init?: Partial<IClearAssociationAction>) {
    super(init);
    this.association = init?.association!;
    this.object = init?.object!;
  }
  getAssociation(): IAssociation | string {
    return this.association;
  }

  setAssociation(value: IAssociation | string): void {
   ...
   */
  toJSON(): IClearAssociationAction {
   ...
   */
  clone(): ClearAssociationAction {
    return new ClearAssociationAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IClearAssociationAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof ClearAssociationAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `ClearAssociationAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): ClearAssociationAction {
    const instance = new ClearAssociationAction();
  ...
  static validate(instance: IClearAssociationAction): ValidationResult {
    if (instance instanceof ClearAssociationAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new ClearAssociationAction(instance);
