...
export type PackageKey = Pick<IPackage, 'name' | 'nameExpression'>;
export type PackageMetadata = Pick<IPackage, 'ownedComment' | 'visibility' | 'ownedRule' | 'ownedTemplateSignature'>;
export type PackageSummary = Pick<IPackage, 'eAnnotations' | 'ownedComment' | 'name'>;
