/**
 * Implementation class for EncapsulatedClassifier
 * 
 * @since UML 2.5
 * @package uml
 * @abstract
...
export class EncapsulatedClassifier extends StructuredClassifier implements IEncapsulatedClassifier {
   ...
   */
  toJSON(): IEncapsulatedClassifier {
   ...
   */
  clone(): EncapsulatedClassifier {
    return new EncapsulatedClassifier(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IEncapsulatedClassifier>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof EncapsulatedClassifier)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `EncapsulatedClassifier{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static validate(instance: IEncapsulatedClassifier): ValidationResult {
    if (instance instanceof EncapsulatedClassifier) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new EncapsulatedClassifier(instance);
