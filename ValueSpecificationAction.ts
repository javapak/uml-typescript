/**
 * Implementation class for ValueSpecificationAction
 * 
 * @since UML 2.5
 * @package uml
 * @extends Action
...
export class ValueSpecificationAction extends Action implements IValueSpecificationAction {
  /**
   * result
   * 
   * @type OutputPin
  ...
  constructor(init?: Partial<IValueSpecificationAction>) {
    super(init);
   ...
   */
  toJSON(): IValueSpecificationAction {
   ...
   */
  clone(): ValueSpecificationAction {
    return new ValueSpecificationAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IValueSpecificationAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof ValueSpecificationAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `ValueSpecificationAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): ValueSpecificationAction {
    const instance = new ValueSpecificationAction();
  ...
  static validate(instance: IValueSpecificationAction): ValidationResult {
    if (instance instanceof ValueSpecificationAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new ValueSpecificationAction(instance);
