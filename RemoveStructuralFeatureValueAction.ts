/**
 * Implementation class for RemoveStructuralFeatureValueAction
 * 
 * @since UML 2.5
 * @package uml
...
export class RemoveStructuralFeatureValueAction extends WriteStructuralFeatureAction implements IRemoveStructuralFeatureValueAction {
  /**
   * isRemoveDuplicates
   * 
   * @type Boolean
  ...
  constructor(init?: Partial<IRemoveStructuralFeatureValueAction>) {
    super(init);
   ...
   */
  toJSON(): IRemoveStructuralFeatureValueAction {
   ...
   */
  clone(): RemoveStructuralFeatureValueAction {
    return new RemoveStructuralFeatureValueAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IRemoveStructuralFeatureValueAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof RemoveStructuralFeatureValueAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `RemoveStructuralFeatureValueAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): RemoveStructuralFeatureValueAction {
    const instance = new RemoveStructuralFeatureValueAction();
  ...
  static validate(instance: IRemoveStructuralFeatureValueAction): ValidationResult {
    if (instance instanceof RemoveStructuralFeatureValueAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new RemoveStructuralFeatureValueAction(instance);
