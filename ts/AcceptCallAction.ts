/**
 * Implementation class for AcceptCallAction
 * 
 * @since UML 2.5
 * @package uml
...
export class AcceptCallAction extends AcceptEventAction implements IAcceptCallAction {
  /**
   * returnInformation
   * 
   * @type OutputPin
  ...
  setReturnInformation(value: IOutputPin): void {
   ...
   */
  clone(): AcceptCallAction {
    return new AcceptCallAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IAcceptCallAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof AcceptCallAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `AcceptCallAction{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static validate(instance: IAcceptCallAction): ValidationResult {
    if (instance instanceof AcceptCallAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new AcceptCallAction(instance);
