/**
 * Implementation class for AddStructuralFeatureValueAction
 * 
 * @since UML 2.5
 * @package uml
...
export class AddStructuralFeatureValueAction extends WriteStructuralFeatureAction implements IAddStructuralFeatureValueAction {
  /**
   * insertAt
   * 
   * @type InputPin
   ...
   */
  toJSON(): IAddStructuralFeatureValueAction {
   ...
   */
  clone(): AddStructuralFeatureValueAction {
    return new AddStructuralFeatureValueAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IAddStructuralFeatureValueAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof AddStructuralFeatureValueAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `AddStructuralFeatureValueAction{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static validate(instance: IAddStructuralFeatureValueAction): ValidationResult {
    if (instance instanceof AddStructuralFeatureValueAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new AddStructuralFeatureValueAction(instance);
