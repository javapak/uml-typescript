/**
 * Implementation class for StartObjectBehaviorAction
 * 
 * @since UML 2.5
 * @package uml
 * @extends CallAction
...
export class StartObjectBehaviorAction extends CallAction implements IStartObjectBehaviorAction {
  /**
   * object
   * 
   * @type InputPin
  ...
  constructor(init?: Partial<IStartObjectBehaviorAction>) {
    super(init);
   ...
   */
  toJSON(): IStartObjectBehaviorAction {
   ...
   */
  clone(): StartObjectBehaviorAction {
    return new StartObjectBehaviorAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IStartObjectBehaviorAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof StartObjectBehaviorAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `StartObjectBehaviorAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): StartObjectBehaviorAction {
    const instance = new StartObjectBehaviorAction();
  ...
  static validate(instance: IStartObjectBehaviorAction): ValidationResult {
    if (instance instanceof StartObjectBehaviorAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new StartObjectBehaviorAction(instance);
