/**
 * Implementation class for CreateLinkObjectAction
 * 
 * @since UML 2.5
 * @package uml
...
export class CreateLinkObjectAction extends CreateLinkAction implements ICreateLinkObjectAction {
  /**
   * result
   * 
   * @type OutputPin
   ...
   */
  toJSON(): ICreateLinkObjectAction {
   ...
   */
  clone(): CreateLinkObjectAction {
    return new CreateLinkObjectAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<ICreateLinkObjectAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof CreateLinkObjectAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `CreateLinkObjectAction{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static validate(instance: ICreateLinkObjectAction): ValidationResult {
    if (instance instanceof CreateLinkObjectAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new CreateLinkObjectAction(instance);
