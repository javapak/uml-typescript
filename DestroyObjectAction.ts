/**
 * Implementation class for DestroyObjectAction
 * 
 * @since UML 2.5
 * @package uml
 * @extends Action
...
export class DestroyObjectAction extends Action implements IDestroyObjectAction {
  /**
   * isDestroyLinks
   * 
   * @type Boolean
   ...
   * @multiplicity [1..1]
   */
  public isDestroyOwnedObjects!: boolean;
  ...
  setIsDestroyLinks(value: boolean): void {
    this.isDestroyLinks = value;
  }

  getIsDestroyOwnedObjects(): boolean {
    return this.isDestroyOwnedObjects;
  }

  setIsDestroyOwnedObjects(value: boolean): void {
    this.isDestroyOwnedObjects = value;
  }
   ...
   */
  toJSON(): IDestroyObjectAction {
    const parentJson = super.toJSON();
    return {
      ...parentJson,
      isDestroyLinks: this.isDestroyLinks,
      isDestroyOwnedObjects: this.isDestroyOwnedObjects,
      target: this.target,
    };
  }
  ...
  toJSONSerialized(): any {
    ...
    result.isDestroyLinks = this.isDestroyLinks;
    result.isDestroyOwnedObjects = this.isDestroyOwnedObjects;
   ...
   */
  clone(): DestroyObjectAction {
    return new DestroyObjectAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IDestroyObjectAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof DestroyObjectAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `DestroyObjectAction{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static fromJSON(json: any): DestroyObjectAction {
    ...
    instance.isDestroyLinks = json.isDestroyLinks;
    instance.isDestroyOwnedObjects = json.isDestroyOwnedObjects;
  ...
  validate(): ValidationResult {
    ...
    if (this.isDestroyLinks == null) {
      errors.push({
        property: 'isDestroyLinks',
        message: 'isDestroyLinks is required',
        code: 'REQUIRED'
      });
    }
    if (this.isDestroyLinks !== undefined) {
      if (typeof this.isDestroyLinks !== 'boolean') {
        errors.push({
          property: 'isDestroyLinks',
          message: 'isDestroyLinks must be a boolean',
          code: 'TYPE_ERROR',
          value: this.isDestroyLinks
        });
      }
    }
    if (this.isDestroyOwnedObjects == null) {
      errors.push({
        property: 'isDestroyOwnedObjects',
        message: 'isDestroyOwnedObjects is required',
        code: 'REQUIRED'
      });
    }
    if (this.isDestroyOwnedObjects !== undefined) {
      if (typeof this.isDestroyOwnedObjects !== 'boolean') {
        errors.push({
          property: 'isDestroyOwnedObjects',
          message: 'isDestroyOwnedObjects must be a boolean',
          code: 'TYPE_ERROR',
          value: this.isDestroyOwnedObjects
        });
      }
    }
    if (this.target == null) {
  ...
  static validate(instance: IDestroyObjectAction): ValidationResult {
    if (instance instanceof DestroyObjectAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new DestroyObjectAction(instance);
