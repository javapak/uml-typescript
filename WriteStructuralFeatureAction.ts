/**
 * Implementation class for WriteStructuralFeatureAction
 * 
 * @since UML 2.5
 * @package uml
 * @abstract
...
export class WriteStructuralFeatureAction extends StructuralFeatureAction implements IWriteStructuralFeatureAction {
  /**
   * result
   * 
   * @type OutputPin
  ...
  constructor(init?: Partial<IWriteStructuralFeatureAction>) {
    super(init);
   ...
   */
  toJSON(): IWriteStructuralFeatureAction {
   ...
   */
  clone(): WriteStructuralFeatureAction {
    return new WriteStructuralFeatureAction(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IWriteStructuralFeatureAction>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof WriteStructuralFeatureAction)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `WriteStructuralFeatureAction{name: ${this.name || 'unnamed'}}`;
  }

  /**
   * Creates an instance from a JSON-serialized object
   */
  static fromJSON(json: any): WriteStructuralFeatureAction {
    const instance = new WriteStructuralFeatureAction();
  ...
  static validate(instance: IWriteStructuralFeatureAction): ValidationResult {
    if (instance instanceof WriteStructuralFeatureAction) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new WriteStructuralFeatureAction(instance);
