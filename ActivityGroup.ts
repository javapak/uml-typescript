/**
 * Implementation class for ActivityGroup
 * 
 * @since UML 2.5
 * @package uml
 * @abstract
...
export class ActivityGroup extends NamedElement implements IActivityGroup {
   ...
   */
  update(values: Partial<IActivityGroup>): void {
   ...
   */
  toString(): string {
    return `ActivityGroup{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static validate(instance: IActivityGroup): ValidationResult {
    if (instance instanceof ActivityGroup) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new ActivityGroup(instance);
