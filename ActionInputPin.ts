/**
 * Implementation class for ActionInputPin
 * 
 * @since UML 2.5
 * @package uml
 * @extends InputPin
...
export class ActionInputPin extends InputPin implements IActionInputPin {
  /**
   * fromAction
   * 
   * @type Action
  ...
  setFromAction(value: IAction): void {
  ...
  toJSONSerialized(): any {
    ...
    result.fromAction = this.fromAction;
   ...
   */
  clone(): ActionInputPin {
    return new ActionInputPin(this);
  }

  /**
   * Updates this instance with values from another object
   */
  update(values: Partial<IActionInputPin>): void {
  ...
  equals(other: any): boolean {
    if (!(other instanceof ActionInputPin)) {
      return false;
    }
   ...
   */
  toString(): string {
    return `ActionInputPin{name: ${this.name || 'unnamed'}}`;
  }
  ...
  static fromJSON(json: any): ActionInputPin {
    ...
    instance.fromAction = json.fromAction;
  ...
  validate(): ValidationResult {
    ...
    if (this.fromAction == null) {
      errors.push({
        property: 'fromAction',
        message: 'fromAction is required',
        code: 'REQUIRED'
      });
    }
  ...
  static validate(instance: IActionInputPin): ValidationResult {
    if (instance instanceof ActionInputPin) {
      return instance.validate();
    }
    // Validate plain object
    const temp = new ActionInputPin(instance);
